...
GuiControl,, pl3, +10
GuiControl,, pl3, +20
RunWait, %ComSpec% /c youtube-dl.exe --extract-audio --audio-format mp3 --rm-cache-dir %UserInput%, C:\Easy-Play\Files\, hide
GuiControl,, pl3, +40
...
GuiControl,, pl1, +10
GuiControl,, pl1, +20
RunWait, %ComSpec% /c youtube-dl.exe --extract-audio --audio-format mp3 --rm-cache-dir %Urls%, C:\Easy-Play\Files\, hide
GuiControl,, pl1, +40
MsgBox, 0, download..., Songs downloaded and added successfully!
;Youtube Mp3 File Abfrage
Loop{
...
GuiControl,, pl2, +10
GuiControl,, pl2, +20
RunWait, %ComSpec% /c youtube-dl.exe --extract-audio --audio-format mp3 --rm-cache-dir %Urls1%, C:\Easy-Play\Files\, hide
GuiControl,, pl2, +40
MsgBox, 0, download..., Songs downloaded and added successfully!
;Youtube Mp3 File Abfrage
Loop{
...
GuiControl,, pl3, +10
GuiControl,, pl3, +20
RunWait, %ComSpec% /c youtube-dl.exe --extract-audio --audio-format mp3 --rm-cache-dir %Urls2%, C:\Easy-Play\Files\, hide
GuiControl,, pl3, +40
MsgBox, 0, download..., Songs downloaded and added successfully!
;Youtube Mp3 File Abfrage
Loop{
...
GuiControl, hide, 4
GuiControl, hide, 44
Gui, Add, Progress, x680 y520 w90 h15 cgreen vplshared
