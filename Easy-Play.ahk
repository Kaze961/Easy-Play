...
Gui,Add,Progress,  x85 y2 w80 h26 Disabled Background3D3D3D
Gui,Add,Text,yp wp hp cwhite BackgroundTrans Center 0x200 goverlay , Overlay
...
Gui,Add,Progress,  x272 y331 w140 h20 Disabled v11 Background3D3D3D
...
Gui,Add,Progress, x452 y331 w140 h20 Disabled v22 Background3D3D3D
Gui,Add,Text,yp wp hp cwhite BackgroundTrans Center 0x200 v2 gdownloadplaylist2 , Add to Library
Gui,Add,Progress,  x632 y331 w140 h20 Disabled v33 Background3D3D3D
...
Gui,Add,Progress,  x272 y355 w68 h15 Disabled v187 Background3D3D3D
Gui,Add,Text,yp wp hp cwhite BackgroundTrans Center 0x200 gshare v1871, share
Gui,Add,Progress,  x452 y355 w68 h15 Disabled v188 Background3D3D3D
Gui,Add,Text,yp wp hp cwhite BackgroundTrans Center 0x200 v1881 gshare1, share
Gui,Add,Progress,  x632 y355 w68 h15 Disabled v189 Background3D3D3D
Gui,Add,Text,yp wp hp cwhite BackgroundTrans Center 0x200 v1891 gshare2, share
Gui,Add,Progress,  x344 y355 w68 h15 Disabled v361 Background3D3D3D
Gui,Add,Text,yp wp hp cwhite BackgroundTrans Center 0x200 vadd gaddsong1, add Song
Gui,Add,Progress,  x524 y355 w68 h15 Disabled v362 Background3D3D3D 
Gui,Add,Text,yp wp hp cwhite BackgroundTrans Center 0x200 vadd1 gaddsong2, add Song
Gui,Add,Progress,  x704 y355 w68 h15 Disabled v363 Background3D3D3D 
Gui,Add,Text,yp wp hp cwhite BackgroundTrans Center 0x200 vadd2 gaddsong3, add Song
...
GuiControl, Hide, 44
GuiControl, Hide, add
GuiControl, Hide, add1
GuiControl, Hide, add2
GuiControl, Hide, 361
GuiControl, Hide, 362
GuiControl, Hide, 363
...
;Overlay
overlay:
MsgBox,0, Overlay, Windowed and Borderless-Fullscreen only!!!
IfMsgBox, OK
run, C:\Easy-Play\Files\overlay.exe
return
;Lautstärke
Volume:
Gui,Submit,NoHide
...
Loop
{
    ...
    FileAppend, %line%, C:\Easy-Play\Playlists\overlay.txt
    sleep, 100
	Soundplay, C:\Easy-Play\%line%, wait
    FileDelete, C:\Easy-Play\Playlists\overlay.txt
}
GuiControl, Hide, stop
...
Loop, parse, FileList, `n, `r
    ...
    FileDelete, C:\Easy-Play\Playlists\overlay.txt
    FileAppend, %line1%, C:\Easy-Play\Playlists\overlay.txt
    sleep, 100
...
GuiControl,, pl3, +20
v := "%(title)s.%(ext)s"
RunWait, %ComSpec% /c yt-dlp.exe --extract-audio --audio-format mp3 --rm-cache-dir -o %v% %UserInput%, C:\Easy-Play\Files\, hide
GuiControl,, pl3, +40
...
if errorlevel
    Exit
RunWait, %ComSpec% /c yt-dlp.exe --ignore-errors --format bestaudio --extract-audio --audio-format mp3 --audio-quality 160K --yes-playlist %UserInput2%, C:\Easy-Play\Files\
MsgBox, 0, download..., Songs downloaded and added successfully!
;Youtube Mp3 File Abfrage
Loop{
    if FileExist("C:\Easy-Play\Files\*.mp3")
...
GuiControl,, Progress, +50
sleep, 300
MsgBox, 0, Fixer, not needed anymore
...
GuiControl,, pl1, +20
v1 := "%(title)s.%(ext)s"
RunWait, %ComSpec% /c yt-dlp.exe --extract-audio --audio-format mp3 --rm-cache-dir -o %v1% %Urls%, C:\Easy-Play\Files\, hide
GuiControl,, pl1, +40
MsgBox, 0, download..., Songs downloaded and added successfully!
;Youtube Mp3 File Abfrage
Loop{
...
GuiControl,, pl2, +20
v2 := "%(title)s.%(ext)s"
RunWait, %ComSpec% /c yt-dlp.exe --extract-audio --audio-format mp3 --rm-cache-dir -o %v2% %Urls1%, C:\Easy-Play\Files\, hide
GuiControl,, pl2, +40
MsgBox, 0, download..., Songs downloaded and added successfully!
;Youtube Mp3 File Abfrage
Loop{
...
GuiControl,, pl3, +20
v3 := "%(title)s.%(ext)s"
RunWait, %ComSpec% /c yt-dlp.exe --extract-audio --audio-format mp3 --rm-cache-dir -o %v3% %Urls2%, C:\Easy-Play\Files\, hide
GuiControl,, pl3, +40
MsgBox, 0, download..., Songs downloaded and added successfully!
;Youtube Mp3 File Abfrage
Loop{
...
sleep, 300
GuiControl,, plshared, +20
RunWait, %ComSpec% /c yt-dlp.exe --extract-audio --audio-format mp3 --rm-cache-dir %Urlsshared%, C:\Easy-Play\Files\, hide
...
return
addsong1:
InputBox, addedsongs1, Download-List, Paste in the Youtube-Link from the Songs you want to add to your Playlist and split each with a Space                                        Example: Link Link Link..,,, 160
if ErrorLevel
    Exit
FileAppend, %A_Space%%addedsongs1%, C:\Easy-Play\Playlists\Playlist1.txt
MsgBox, 0, Song(s) added, Song(s) added
return
addsong2:
InputBox, addedsongs21, Download-List, Paste in the Youtube-Link from the Songs you want to add to your Playlist and split each with a Space                                        Example: Link Link Link..,,, 160
if ErrorLevel
    Exit
FileAppend, %A_Space%%addedsongs21%, C:\Easy-Play\Playlists\Playlist2.txt
MsgBox, 0, Song(s) added, Song(s) added
return
addsong3:
InputBox, addedsongs31, Download-List, Paste in the Youtube-Link from the Songs you want to add to your Playlist and split each with a Space                                        Example: Link Link Link..,,, 160
if ErrorLevel
    Exit
FileAppend, %A_Space%%addedsongs31%, C:\Easy-Play\Playlists\Playlist3.txt
MsgBox, 0, Song(s) added, Song(s) added
return
;X
GuiClose:
