...
FileMove, %A_Desktop%\Easy-Play SETUP\del.png, C:\Easy-Play\Covers
FileMove, %A_Desktop%\Easy-Play SETUP\add.png, C:\Easy-Play\Covers
FileMove, %A_Desktop%\Easy-Play SETUP\del.png, C:\Easy-Play\Covers
FileMove, %A_Desktop%\Easy-Play SETUP\play.png, C:\Easy-Play\Covers
FileMove, %A_Desktop%\Easy-Play SETUP\del.png, C:\Easy-Play\Covers
FileMove, %A_Desktop%\Easy-Play SETUP\reload.png, C:\Easy-Play\Covers
FileMove, %A_Desktop%\Easy-Play SETUP\skip.png, C:\Easy-Play\Covers
FileMove, %A_Desktop%\Easy-Play SETUP\stop.png, C:\Easy-Play\Covers
FileMove, %A_Desktop%\Easy-Play SETUP\pastebin.exe, C:\Easy-Play\Files
